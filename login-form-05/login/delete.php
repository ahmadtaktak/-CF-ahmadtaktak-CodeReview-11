...
<fieldset>
<legend class='h2 mb-3' >Delete request <img class= 'img-thumbnail rounded-circle'  src='../picture/<?php echo $picture ?>' alt="<?php echo $f_name ?>"></legend >
